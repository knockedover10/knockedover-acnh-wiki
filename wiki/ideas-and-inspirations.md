...
A scratchpad for build concepts, district visions, and anything worth revisiting. Move to the relevant wiki page once an idea becomes a plan.
...
- Bamboo fence border on at least two sides
- Pine or cedar trees surrounding — heavier foliage than the rest of the island
...
|----------|------|-----------|-------------|
| Main village street | Lively, commercial | Lanterns, stalls, seasonal flowers | [Island Layout](island-layout.md#village-core) |
| Shrine district | Sacred, elevated | Torii, lanterns, offerings, white/red flowers | [Island Layout](island-layout.md#shrine-district) |
| Bamboo grove | Wild, meditative | Bamboo, dirt paths, rest area | [Island Layout](island-layout.md#bamboo-grove) |
| Graveyard | Dark, still | Headstones, black roses, sparse trees | [Island Layout](island-layout.md#graveyard) |
| Onsen | Hidden, warm | Outdoor bath, bamboo fence, pines | [Island Layout](island-layout.md#onsen) |
| Villager clusters | Domestic, lived-in | Personalised house areas, gardens | [Villagers](villagers.md) |
...
| **Pekoe** | Village core | Warm kimono interior; domestic garden with chrysanthemums |
| **Ken** | Martial area or elevated spot | Samurai dojo feeling; simple, strong lines |
| **Snake** | Edge of village | Lean-to aesthetic; practise area nearby |
| **Genji** | Quiet, domestic | Literary feel; soft colours, mochi items inside |
| **Greta** | Artistic corner | Geisha house feel; red lanterns, artistic exterior |
| **Gladys/Blanche** | Near water | Crane by the water — very classical Japanese painting energy |
...
- Consider whether to maintain cherry blossom trees island-wide or just in the shrine area — seasonal vs. permanent look
- Decide on a consistent path design before placing too many outdoor items (hard to redo later)
- Note: terraforming is unlocked after K.K. Slider's first concert — all layout plans are provisional until then
